...
//		} catch (InstantiationException | IllegalAccessException | ClassNotFoundException ex) {
    ...
    public double[] testWithData3(){
        ...
        try {
            ...
            NaiveBayes_Modified c  = (NaiveBayes_Modified) Class.forName("" + clsName).newInstance();
            c.train(isCategory_train, features_train, labels_train);
...
//		} catch (InstantiationException | IllegalAccessException | ClassNotFoundException ex) {
    ...
    public double[] testWithData4(){
        ...
        try {
            ...
            NaiveBayes_Modified2 c  = (NaiveBayes_Modified2) Class.forName("" + clsName).newInstance();
            c.train(isCategory_train, features_train, labels_train);
