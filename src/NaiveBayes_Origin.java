...
public class NaiveBayes_Origin {
/*
    ArrayList<Integer> trainData;
...
//public class NaiveBayes {//extends Classifier {
     ...
     * */
    public void train(boolean[] isCategory, double[][] features, double[] labels){
        //System.out.println("length:"+features.length+" "+features[0].length);
        //System.out.println("labellength:"+labels.length);
     ...
     * */
    public double predict(double[] features) {
        //System.out.println("featurelength:"+features.length);
...
//            	System.out.println("值为"+lblClass.get(i)+"的个数有"+lblCount.get(i)+"概率是"+lblCount.get(i)/(float)labels.length);
    ...
    public static void main(String [] args){
        NaiveBayes_Origin modified = new NaiveBayes_Origin();
