...
//			System.out.println(testLine);
            ...
            // conduct 10-cv
            Evaluation eva = new Evaluation(dataset,features,labels, "NaiveBayes_Modified2");
            result.add(eva.testWithData4()[0]);
    ...
    public static double processSingleTestMain(String trainFile, String line) throws FileNotFoundException{
        ...
        // conduct 10-cv
        Evaluation eva = new Evaluation(dataset,features,labels, "NaiveBayes_Modified2");
        double[] result = eva.testWithData4();
        return result[0];
        //eva.crossValidation();
    }
