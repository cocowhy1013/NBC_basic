...
/*
 * upsorn: 11/08/2009 - need to work on nesting (17) SID: If-Statement Deletion,
 * (18) SFD: For-Statement Deletion, (19) SSD: Switch-Statement Deletion, (20)
 * SWD: While-Statement Deletion
 */
	...
	public void compileMutants() {
		if (traditionalOp != null && traditionalOp.length > 0) {
			try {
				...
				e.printStackTrace();
				System.err
						.println("Error at compileMutants() in TraditionalMutantsGenerator.java");
			}
		}
	}
		...
		for (int j = 0; j < cdecls.size(); ++j) {
			...
			if (tempName.equals(MutationSystem.CLASS_NAME)) {
				try {
					...
					System.err
							.println("Exception, during generating traditional mutants for the class "
