...
public abstract class EvaluationShuttle extends ParseTreeVisitor {
	 ...
	 * @throws ParseTreeException
	 */
	public MemberDeclaration evaluateDown(EnumDeclaration p)
			throws ParseTreeException {
		return p;
	}
	...
	public EnumConstantList evaluateDown(EnumConstantList p)
			throws ParseTreeException {
		return p;
	}
	...
	public TypeParameter evaluateDown(TypeParameter p)
			throws ParseTreeException {
		return p;
	}

	public TypeParameterList evaluateDown(TypeParameterList p)
			throws ParseTreeException {
		return p;
	}
	 ...
	 */
	public MemberDeclaration evaluateUp(EnumDeclaration p)
			throws ParseTreeException {
		return p;
	}
	...
	public EnumConstantList evaluateUp(EnumConstantList p)
			throws ParseTreeException {
		return p;
	}
	...
	public TypeParameterList evaluateUp(TypeParameterList p)
			throws ParseTreeException {
		return p;
	}
