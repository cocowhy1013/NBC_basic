...
public class ASRS extends MethodLevelMutator {
	public ASRS(FileEnvironment file_env, ClassDeclaration cdecl,
	 ...
	 * assignment operator is of logical type (&=, |=, ^=), replace it with each
	 * of the other logical assignment operators. If the assignment operator is
	 * a shift operator (<<, >>, >>>) replace it with each of the other shift
	 * operators.
	 */
	...
	/*
	 * Replace the arithmetic assignment operator (+=, -+, *=, /=, %=) by each
	...
	/*
	 * Replace the shift assignment operator (<<=, >>=, >>>=) by each of the
	 * other operators
	 */
