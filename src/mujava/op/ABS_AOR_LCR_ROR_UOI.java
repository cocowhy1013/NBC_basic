 ...
 * <=, >, >=, =, <>) by each of the other operators and by <i>falseOp</i> which
 * assigns a <i>false</i> value to a predicate, and <i>trueOp</i> which assigns
 * a <i>true</i> value to a predicate <br />
...
public class ABS_AOR_LCR_ROR_UOI extends mujava.op.util.Mutator {
	...
	public ABS_AOR_LCR_ROR_UOI(FileEnvironment file_env,
