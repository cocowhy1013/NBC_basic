...
public class DeclAnalyzer extends OJClass {
	...
	public String getSourceName(OJClass clazz) {
		...
		// name =
		// MutationSystem.getPrefix()+getClassName()+"_"+this.num+".java";
		return name;
	}
	...
	public boolean sameSignature(OJMethod m1, OJMethod m2) {
		return (m1.getName().equals(m2.getName())
				&& m1.getReturnType().equals(m2.getReturnType()) && isSameParameter(
				m1, m2));
	}
	...
	public DeclAnalyzer(java.lang.Class oj_param0,
			openjava.mop.MetaInfo oj_param1) {
