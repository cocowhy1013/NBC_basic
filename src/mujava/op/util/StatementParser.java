...
public class StatementParser {
	...
	/**
	 * Read and extract a given string to form an openjava.ptree.IfStatement
	 * object. The IfStatement object will be returned and used by if-statement
	 * deletion operator in order to mutate nested if-statement.
	 * 
	 * @param s
	 * @param keyword
	 * @return ifstmt
	 ...
	 */
	public IfStatement readString(String s, String keyword)
			throws ParseTreeException {
		...
		while (str_token.hasMoreTokens()) {
			...
			System.out.println("str_token[" + token_cnt + "] ="
					+ str_token.nextToken());
